...
import { ScientistFeedback } from "./schemas";

export function buildSeedFeedback(now = new Date().toISOString()): ScientistFeedback[] {
  const base = {
    created_at: now,
    source_plan_id: "seed",
  ...
  return [
    ...
    },
    {
      ...
      reason:
        "Cell-line quality and standard control are necessary to interpret cryopreservation comparisons.",
      rating_before: 3,
      derived_rule:
